...
func TestParseUintMissingArgument(t *testing.T) {
	...
	var a uint
	var b uint
	p.UintVarP(&a, 't', "little", "little")
	p.UintVarP(&b, 'T', "big", "big")
