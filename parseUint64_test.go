...
func TestParseUint64MissingArgument(t *testing.T) {
	...
	var a uint64
	var b uint64
	p.Uint64VarP(&a, 't', "little", "little")
	p.Uint64VarP(&b, 'T', "big", "big")
